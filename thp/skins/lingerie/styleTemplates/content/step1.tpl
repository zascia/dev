...
<div class="regSep"><span class="txtContentTitle">{LANG_EXPRESS_TITLE}</span>
<p>{LANG_EXPRESS_DESC}</p>
<a href="cart.php?act=express" class="txtCheckout">{LANG_EXPRESS_TITLE}</a>
</div>
