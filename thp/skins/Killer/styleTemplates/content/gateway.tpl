...
<div class="boxContent">
			...
			<form action="{VAL_FORM_ACTION}" method="{VAL_FORM_METHOD}" name="gateway" target="{VAL_TARGET}">
				...
				<!-- BEGIN: transfer -->
					...
					<p><img src="skins/{VAL_SKIN}/styleImages/progress.gif"  alt="" title=""/></p>
					<p><img src="skins/{VAL_SKIN}/styleImages/px.jpg"  alt="" title="" onload="submitDoc('gateway');" /></p>
					<!-- END: auto_submit-->
					<!-- BEGIN: manual_submit-->
			  ...
			  <!-- END: manual_submit-->
			  {FORM_PARAMETERS}<br />
			  <span class="style1">Tryk p&aring; knappen herunder, hvis betalingsvinduet ikke &aring;bner automatisk.</span>			  <br />
		      <!-- END: transfer -->
