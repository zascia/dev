...
<div class="boxContent">
	...
	<table  border="0" cellspacing="0" cellpadding="3" width="100%">
	  ...
	  <tr>
	    ...
	    <td><input name="add_1" type="text" class="textbox" id="add_1" size="16" value="{VAL_ADD_1}" tabindex="4" />
*</td>
	    </tr>
	  <tr>
		...
		<td><input name="firstName" type="text" class="textbox" id="firstName" size="16" value="{VAL_FIRST_NAME}" tabindex="2" /> 
		  *</td>
		<td>&nbsp;</td>
		<td><input name="add_2" type="text" class="textbox" id="add_2" size="16" value="{VAL_ADD_2}" tabindex="5" /></td>
	  </tr>
	  <tr>
		...
		<td><input name="lastName" type="text" class="textbox" id="lastName" size="16" value="{VAL_LAST_NAME}" tabindex="3" /> 
		  * </td>
		<td>{LANG_POSTCODE}</td>
		<td><input name="postcode" type="text" class="textbox" id="postcode" size="16" value="{VAL_POSTCODE}" tabindex="6" />
*</td>
	  </tr>
	  <tr>
		<td>{LANG_TELEPHONE}</td>
		<td><input name="phone" type="text" class="textbox" id="phone" size="16" value="{VAL_PHONE}" tabindex="10" />
*</td>
		<td>{LANG_TOWN}</td>
		<td><input name="town" type="text" class="textbox" id="town" size="16" value="{VAL_TOWN}" tabindex="7" />
*</td>
	  </tr>
	  <tr>
		<td>{LANG_MOBILE}</td>
		<td><input name="mobile" type="text" class="textbox" id="mobile" size="16" value="{VAL_MOBILE}" tabindex="11" />		  </td>
		<td>{LANG_COUNTRY}</td>
	    <td nowrap='nowrap'><select name="country" class="textbox" tabindex="8">
	  ...
	  <tr>
		...
		<td><input name="email" type="text" class="textbox" id="email" size="16" value="{VAL_EMAIL}" tabindex="12" />
* </td>
	    <td>{LANG_COUNTY}</td>
	    <td><input name="county" type="text" class="textbox" id="county" size="16" value="{VAL_COUNTY}" tabindex="9" />
*</td>
	  </tr>
	  <tr>
