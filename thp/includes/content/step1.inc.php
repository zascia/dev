...
// Express checkout mod Toucan Web Design www.toucanwebdesign.com


$login_register->assign("LANG_REGISTER_EXPR",$lang['front']['step1']['quick_register']);
$login_register->assign("LANG_EXPRESS_DESC",$lang['front']['step1']['expresso']);
$login_register->assign("LANG_EXPRESS_TITLE",$lang['front']['step1']['express_title']);
