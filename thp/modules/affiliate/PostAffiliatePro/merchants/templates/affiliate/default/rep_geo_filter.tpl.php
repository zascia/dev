...
<tr><td><?php echo L_G_GEOSTATS_DESCRIPTION?><br><br></td></tr>
</table>
<table class=listing border=0 cellspacing=0 cellpadding=2 width="780" style="border-bottom: 0px;">
<?php QUnit_Templates::printFilter(6, L_G_GEOSTATS); ?>
    <tr class="listheader">
      <td align=left valign="top">
           <?php QUnit_Global::includeTemplate('filter_time.tpl.php'); ?>
           <br>
           <b><?php echo L_G_NUMBEROFTOPCOUNTRIES?></b>&nbsp;<?php showQuickHelp(L_G_HLP_NUMBEROFTOPCOUNTRIES); ?>&nbsp;
    ...
    <tr class="listheader">
      ...
      <input type=hidden name=md value='Affiliate_Merchants_Views_GeoReports'>
