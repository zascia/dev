...
.toolbarButton {
	BORDER-RIGHT: buttonface 1px solid; BORDER-TOP: buttonface 1px solid; LEFT: 0px; BORDER-LEFT: buttonface 1px solid; CURSOR: pointer; BOTTOM: 0px; BORDER-BOTTOM: buttonface 1px solid; POSITION: relative; TOP: 0px; BACKGROUND-COLOR: buttonface
}
.toolbarButtonMouseOver2 {
	BORDER-RIGHT: buttonface 1px solid; BORDER-TOP: buttonface 1px solid; LEFT: 0px; BORDER-LEFT: buttonface 1px solid; WIDTH: 20px; CURSOR: pointer; BOTTOM: 0px; BORDER-BOTTOM: buttonface 1px solid; POSITION: relative; TOP: 0px; BACKGROUND-COLOR: gainsboro
}
.toolbarButtonMouseOver {
	BORDER-RIGHT: buttonhighlight 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; CURSOR: pointer; BORDER-BOTTOM: buttonhighlight 1px solid; POSITION: relative; TOP: 0px; BACKGROUND-COLOR: gainsboro
}
.toolbarButton2 {
	BORDER-RIGHT: buttonface 1px solid; COLOR: black; BORDER-TOP: black 1px solid; LEFT: 0px; BORDER-LEFT: black 1px solid; CURSOR: pointer; BOTTOM: 0px; BORDER-BOTTOM: buttonhighlight 1px solid; BORDER-RIGHT: buttonhighlight 1px solid;POSITION: relative; TOP: 0px; BACKGROUND-COLOR: buttonface
}
.toolbarButton2Clicked {
	BORDER-RIGHT: buttonface 1px solid; COLOR: white; BORDER-TOP: black 1px solid; LEFT: 0px; BORDER-LEFT: black 1px solid; CURSOR: pointer; BOTTOM: 0px; BORDER-BOTTOM: buttonhighlight 1px solid; BORDER-RIGHT: buttonhighlight 1px solid;POSITION: relative; TOP: 0px; BACKGROUND-COLOR: gray
}
.toolbarSeparator {
...
.tbIcon {
	LEFT: 0px; WIDTH: 23px; CURSOR: pointer; BOTTOM: 0px; POSITION: relative; TOP: 0px; HEIGHT: 22px
}
.tbSeparator {
