...
class QUnit_Graphics_HtmlGraph extends BAR_GRAPH
{
...
/*
 +-------------------------------------------------------------------+
 |                   H T M L - G R A P H S   (v2.9)                  |
 |                                                                   |
 | Copyright Gerd Tentler               info@gerd-tentler.de         |
 | Created: Sep. 17, 2002               Last modified: Jan. 30, 2005 |
 +-------------------------------------------------------------------+
...
//----------------------------------------------------------------------------------------------------
    ...
    var $labelBGColor = '';            // label background color: string
    var $labelBorder = '0px';    // label border: string (CSS specification; doesn't work with NN4)
    var $labelFont = 'Tahoma, Arial, Verdana';      // label font family: string (CSS specification)
    var $labelSize = 11;                      // label font size: integer (pixels)
    var $labelType = 'text';                  // label type

    var $barWidth = 11;                       // bar width: integer (pixels)
    var $barLength = 1.0;                     // bar length ratio: float (from 0.1 to 2.9)
    var $barColor = "#2283BF";                            // bar color OR bar image: string with comma-separated values or array
    var $barBGColor = "#E7E7E7";                          // bar background color: string
    var $barBorder = '0px';      // bar border: string (CSS specification; doesn't work with NN4)
    var $barLevelColor;                       // bar level color: array (bLevel, bColor); draw bars >= bLevel with bColor

    var $showValues = 1;                      // show values: 0 = % only, 1 = abs. and %, 2 = abs. only, 3 = none
    ...
    var $absValuesFont = 'Tahoma, Arial, Verdana';  // abs. values font family: string (CSS specification)
    ...
    var $percValuesFont = 'Tahoma, Arial, Verdana'; // perc. values font family: string (CSS specification)
    var $percValuesSize = 11;                 // perc. values font size: integer (pixels)
    ...
    var $legendFont = 'Tahoma, Arial, Verdana';     // legend font family: string (CSS specification)
