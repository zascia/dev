...
class QUnit_Graphics_PostGraph
{
    var $img;
    ...
    * @returns null
    */
    function QUnit_Graphics_PostGraph($width = 400, $height = 300)
    {
    ...
    */
    function drawXAxe()
    {
        ...
        {
            if($this->textXOrientation == 'normal')
    ...
    */
    ...
    /**
    * set orientation of digits at graph x axe
    *
