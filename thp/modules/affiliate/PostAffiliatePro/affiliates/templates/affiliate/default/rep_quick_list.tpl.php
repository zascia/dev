...
<tr>
    <td valign=top align=left class="detailrow0">
...
<?php if (!in_array(AFFSTATUS_NOTAPPROVED, $this->a_denyStatus)) { ?>
      &nbsp;<?php echo L_G_TOTALWAITINGSALES?>&nbsp;
      <b><?php echo $data['sales_waitingapproval']+$data['st_sales_waitingapproval']?></b><br>
<?php } ?>

<?php if (!in_array(AFFSTATUS_SUPPRESSED, $this->a_denyStatus)) { ?>
...
<tr>
  ...
  <table width=100% cellspacing=0 cellpadding=3 border=0>
    <tr class="detailrow<?php echo ($i++)%2?>">
      <td width="20%">&nbsp;</td>
...
<?php if($this->a_Auth->getSetting('Aff_maxcommissionlevels') > 1) { ?>
    <tr class="detailrow<?php echo ($i++)%2?>">
     <td colspan=<?php echo (5-count($this->a_denyStatus))?> align=center><b><?php echo L_G_SECONDTIER?></b></td>
    </tr>
    <tr class="detailrow<?php echo ($i++)%2?>">
      <td>&nbsp;</td>
...
<?php if($this->a_Auth->getSetting('Aff_maxcommissionlevels') > 1) { ?>
    <tr class="detailrow<?php echo ($i++)%2?>">
     <td colspan=<?php echo (6-count($this->a_denyStatus))?> align=center><b><?php echo L_G_SECONDTIER?></b></td>
    </tr>
    <tr class="detailrow<?php echo ($i++)%2?>">
      <td width="20%">&nbsp;</td>
      <td width="16%"><b><?php echo L_G_PAID?></b></td>
