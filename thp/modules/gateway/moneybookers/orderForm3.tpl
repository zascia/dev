...
<form action="https://ssl.ditonlinebetalingssystem.dk/auth/default.aspx"  method="post" name="payment" onSubmit="return checkForm()">
		...
		<div align="center">
		  ...
		  <div align="center">
		    ...
		    <input type="hidden" name="accepturl" value="https://relay.ditonlinebetalingssystem.dk/relay/relay.cgi/www.Nyah-Beauty.com/godken"/>
		    <input type="hidden" name="declineurl" value="https://relay.ditonlinebetalingssystem.dk/relay/relay.cgi/www.Nyah-Beauty.com/annull"/>
          </div>
  </div>
</form><CENTER>
