...
sort($acceptedCards, SORT_NUMERIC);
reset($acceptedCards);
...
elseif ($config['defaultCurrency'] == "CHF")
{
    $currencyNo = 756;
}
...
elseif ($config['defaultCurrency'] == "JPY")
{
    $currencyNo = 392;
}
elseif ($config['defaultCurrency'] == "EUR")
{
    $currencyNo = 978;
}
elseif ($config['defaultCurrency'] == "SEK")
{
    $currencyNo = 752;
}
elseif ($config['defaultCurrency'] == "NOK")
{
    $currencyNo = 578;
}
else
