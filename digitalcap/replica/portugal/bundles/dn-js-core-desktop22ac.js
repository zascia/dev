...
function clientOverrides() {
    var n, i, r, t;
    if (isMacintosh() && jQuery("body").addClass("t-macos"), isLinux() && jQuery("body").addClass("t-linux"), n = getIEVersion(), n > 0 && jQuery("body").addClass("t-browser-ie t-browser-ie-" + n), i = getMSEdge(), i && jQuery("body").addClass("t-browser-msedge"), r = getMOZFirefox(), r && jQuery("body").addClass("t-browser-firefox"), isMobile.any() && jQuery("body").addClass("t-browser-mobile"), isMobile.iOS()) {
        jQuery("body").addClass("t-browser-mobile-ios");
        t = ".t-main, .t-footer, .t-overlay-box-mainsidebar";
        jQuery(document).on("touchmove", function(n) {
            n.preventDefault()
        });
        jQuery("body").on("touchstart", t, function(n) {
            n.currentTarget.scrollTop === 0 ? n.currentTarget.scrollTop = 1 : n.currentTarget.scrollHeight === n.currentTarget.scrollTop + n.currentTarget.offsetHeight && (n.currentTarget.scrollTop -= 1)
        });
        jQuery("body").on("touchmove", t, function(n) {
            n.stopPropagation()
        })
    }
...
function windowScrollProcess() {
    var e = jQuery("body"),
        o = jQuery(".js-site-header"),
        s, i, h, r, c, l, u, a, v, t, n, w, f;
    if (o.length && (s = o[0].getBoundingClientRect(), s.top < 0 ? windowScrollSetPosCls(1, !0) : windowScrollSetPosCls(1, !1)), i = jQuery(".js-main-brand-logo"), i.length && (h = i[0].getBoundingClientRect(), i.is(":visible") && h.bottom - 44 < 0 ? windowScrollSetPosCls(2, !0) : windowScrollSetPosCls(2, !1)), r = jQuery('main article[rel="detalhe-artigo"] h1[rel="headline"]').eq(0), c = jQuery(".js-sticky-article-id").eq(0), r.length && c.length && (l = r[0].getBoundingClientRect(), l.bottom - 44 < 0 ? windowScrollSetPosCls(3, !0) : windowScrollSetPosCls(3, !1)), u = jQuery('main article[rel="detalhe-artigo"]').eq(0), a = jQuery(".js-sticky-article-related").eq(0), u.length && a.length && (v = u[0].getBoundingClientRect(), v.bottom - 250 < 0 ? windowScrollSetPosCls(4, !0) : windowScrollSetPosCls(4, !1)), t = jQuery('main article[rel="detalhe-artigo"] .js-a-content-rm').eq(0), n = t.find(".js-chapter-scroll-1").eq(0), t.length && n.length) {
        var b = t.outerHeight(!0),
            k = t[0].getBoundingClientRect(),
            y = n.outerHeight(!0),
            d = n.parent(),
            p = d[0].getBoundingClientRect();
        b > y + 140 && p.top - 100 < 0 ? (w = Math.abs(p.top - 100), n.addClass("t-chapter-scrolling"), k.bottom - 140 - y > 0 && n.css({
            top: w + "px"
        }).parent().css({
            "border-color": "transparent"
        })) : n.removeClass("t-chapter-scrolling").removeAttr("style").parent().removeAttr("style")
    }
...
function windowAdjustOnClick() {
    jQuery(window).on("click touchend", function() {
        appOverlayCloseBoxes()
    })
}

function windowAdjustOnKeyboard() {
    document.onkeydown = function(n) {
        n = n || window.event;
        n.keyCode == 27 && (appOverlayCloseBoxes(), appOverlayMainSidebarClose())
    }
}

function appMoveHeaderToWinTop() {
    jQuery("html, body").stop().animate({
        scrollTop: jQuery(".js-site-header").offset().top + 1
    }, 400)
}
...
function appOverlayCloseActions() {
    var n = jQuery("body"),
        t = "js-overlay-shadow";
    n.append('<em class="t-overlay-shadow ' + t + '"><\/em>');
    n.off("click", "." + t).on("click", "." + t, function() {
        n.is(".interaction-overlay-box-mainsidebar-open") && appOverlayMainSidebarToggle()
    });
    if (isMobile.iOS()) jQuery("." + t).on("touchmove", function(t) {
        n.is(".interaction-overlay-shadow-open") && t.preventDefault()
    })
}

function appOverlayCloseBoxes() {
    var n = jQuery("body");
    n.removeClass("interaction-overlay-box-notif-open interaction-overlay-box-useracc-open interaction-overlay-box-meteo-open")
}

function appOverlayMainSidebarActions() {
    var n = jQuery("body"),
        u = ".js-mainsidebar-toggle";
    n.off("click", u).on("click", u, function() {
        appOverlayMainSidebarToggle()
    });
    n.append('<aside class="t-mainmenu-submenus js-mainmenu-submenus"><\/aside>');
    var f = jQuery(".js-mainmenu"),
        i = f.find(".js-submenu"),
        e = i.length,
        r = jQuery(".js-mainmenu-submenus"),
        t = 0;
    i.each(function() {
        var u = jQuery(this).children("ul"),
            f = u.clone();
        if (jQuery(this).attr("jsdata-submenu-idx", t).append('<span class="t-submenu-btn js-submenu-btn"><\/span>'), f.attr("jsdata-submenu-idx", t), r.append(f), u.addClass("t-submenu-list-disabled"), t++, t === e) {
            n.off("mouseenter touchend", ".js-mainmenu ul li").on("mouseenter touchend", ".js-mainmenu ul li", function() {
                if (isMobile.iOS() && !jQuery("body").is(".t-scroll-pos-1") && appMoveHeaderToWinTop(), i.removeClass("open"), jQuery(this).is(".js-submenu")) {
                    n.is(".interaction-overlay-box-mainsidebar-submenu-open") || r.scrollTop(0);
                    n.addClass("interaction-overlay-box-mainsidebar-submenu-open");
                    var t = jQuery(this).attr("jsdata-submenu-idx");
                    r.find("ul").removeClass("open").end().find('ul[jsdata-submenu-idx="' + t + '"]').addClass("open");
                    jQuery(this).addClass("open")
                } else n.removeClass("interaction-overlay-box-mainsidebar-submenu-open")
            });
            if (isMobile.iOS()) n.off("touchend", ".js-mainmenu ul li .js-submenu-btn").on("touchend", ".js-mainmenu ul li .js-submenu-btn", function(n) {
                n.stopPropagation()
            })
        }
    })
...
function appOverlayMainSidebarToggle() {
    var n = jQuery("body"),
        i = jQuery(".js-overlay-mainsidebar-content"),
        t = "interaction-overlay-box-mainsidebar-open",
        r = "interaction-overlay-body-overflow";
    n.is("." + t) ? appOverlayMainSidebarClose() : (n.is(".t-scroll-pos-1") || appMoveHeaderToWinTop(), appSearchBarToggle(!1), appMeteoBarToggle(!1), i.scrollTop(0), n.addClass("interaction-overlay-shadow-open " + t), jQuery(".js-mainmenu .js-submenu").removeClass("open"), setTimeout(function() {
        n.addClass(r)
    }, 300))
}

function appOverlayMainSidebarClose() {
    var n = jQuery("body"),
        t = "interaction-overlay-box-mainsidebar-working",
        i = "interaction-overlay-body-overflow";
    n.addClass(t + " interaction-overlay-shadow-working");
    n.removeClass("interaction-overlay-box-mainsidebar-open interaction-overlay-shadow-open interaction-overlay-box-mainsidebar-submenu-open");
    setTimeout(function() {
        n.removeClass(t + " " + i + " interaction-overlay-shadow-working")
    }, 300)
}

function appOverlayMeteoActions() {
    var n = jQuery("body"),
        i = ".js-meteo-toggle",
        t;
    n.off("click", i).on("click", i, function(t) {
        t.stopPropagation();
        n.hasClass("interaction-overlay-box-meteo-open") ? appOverlayCloseBoxes() : (appOverlayCloseBoxes(), appOverlayMeteoOpen())
    });
    t = ".js-meteo-toggle, .js-meteo-dd";
    n.off("click touchstart touchend", t).on("click touchstart touchend", t, function(n) {
        n.stopPropagation()
    })
}

function appOverlayMeteoOpen() {
    var n = jQuery("body"),
        t = jQuery(".js-meteo-dd");
    t.show();
    n.addClass("interaction-overlay-box-meteo-open")
}

function appOverlayNotificationsActions() {
    var n = jQuery("body"),
        i = ".js-usernotific-toggle",
        t;
    n.off("click", i).on("click", i, function(t) {
        t.stopPropagation();
        n.hasClass("interaction-overlay-box-notif-open") ? appOverlayCloseBoxes() : (appOverlayCloseBoxes(), appOverlayNotificationsOpen())
    });
    t = ".js-usernotific-toggle, .js-usernotific-dd";
    n.off("click touchstart touchend", t).on("click touchstart touchend", t, function(n) {
        n.stopPropagation()
    })
}

function appOverlayNotificationsOpen() {
    var n = jQuery("body"),
        t = jQuery(".js-usernotific-dd");
    t.show();
    n.addClass("interaction-overlay-box-notif-open")
}

function appOverlayUserAccountActions() {
    var n = jQuery("body"),
        i = ".js-useraccount-toggle",
        t;
    n.off("click", i).on("click", i, function(t) {
        t.stopPropagation();
        n.hasClass("interaction-overlay-box-useracc-open") ? appOverlayCloseBoxes() : (appOverlayCloseBoxes(), appOverlayUserAccountOpen())
    });
    t = ".js-useraccount-toggle, .js-useraccount-dd";
    n.off("click touchstart touchend", t).on("click touchstart touchend", t, function(n) {
        n.stopPropagation()
    })
}
...
function appOverlayUserAccountOpen() {
    var n = jQuery("body"),
        t = jQuery(".js-useraccount-dd");
    t.show();
    n.addClass("interaction-overlay-box-useracc-open")
}

function appSearchBarActions() {
    var t = jQuery("body"),
        i = ".js-searchbar-toggle",
        n;
    t.off("click", i).on("click", i, function(n) {
        n.stopPropagation();
        appSearchBarToggle(!0)
    });
    n = ".js-searchbar-toggle, .js-searchbar-box";
    t.off("touchstart touchend", n).on("touchstart touchend", n, function(n) {
        n.stopPropagation()
    })
}

function appSearchBarToggle(n) {
    var t = jQuery("body"),
        r = jQuery(".js-searchbar-box"),
        i = "interaction-search-box-open",
        u = r.find(".js-searchbar-field");
    appOverlayMainSidebarClose();
    appOverlayCloseBoxes();
    t.hasClass(i) || !n ? (t.removeClass(i), u.val("")) : (r.show(), t.addClass(i))
}

function appMeteoBarActions() {
    var t = jQuery("body"),
        i = ".js-meteobar-toggle",
        n;
    t.off("click", i).on("click", i, function(n) {
        n.stopPropagation();
        appMeteoBarToggle(!0)
    });
    n = ".js-meteobar-toggle, .js-meteobar-box";
    t.off("touchstart touchend", n).on("touchstart touchend", n, function(n) {
        n.stopPropagation()
    })
}

function appMeteoBarToggle(n) {
    var t = jQuery("body"),
        r = jQuery(".js-meteobar-box"),
        i = "interaction-meteobar-box-open";
    appOverlayMainSidebarClose();
    appOverlayCloseBoxes();
    t.hasClass(i) || !n ? t.removeClass(i) : (r.show(), t.addClass(i))
}
...
function slidersInit() {
    var n, t, i;
    jQuery(".js-s10-head-slider").each(function() {
...
function articleAdjustLayout() {
    jQuery(".js-a-sidebar-adjust-elm-targ").each(function() {
        var n = jQuery(".js-a-sidebar-adjust-elm-ref"),
            t = n.outerHeight();
        jQuery(this).css("margin-top", t * -1)
    });
    jQuery(".js-a-content-body-elm-targ").each(function() {
        var u = jQuery(this).closest('[rel="detalhe-artigo"]'),
            s = jQuery(this).closest(".js-a-content-rm"),
            i = jQuery(".js-a-content-top-elm-ref"),
            f = jQuery(".js-a-content-sb-elm-ref"),
            n, t;
        ...
        var r = f.outerHeight(),
            ...
            o = e + n;
        t = r + 10 >= o ? r - n : "";
        u.is('[data-truncated="true"]') || jQuery(this).css("min-height", t)
    })
}
...
function articleReadMore() {
    jQuery(".js-a-content-rm").each(function() {
        var n = jQuery(this),
            ...
            f = n.find(".js-a-content-rm-full").eq(0),
            e = f.outerHeight(),
            o = n.find(".js-a-content-top-elm-ref").eq(0),
            s = o.outerHeight(),
            h = n.find(".js-a-content-body-elm-targ").eq(0),
            c = h.outerHeight(),
            i = s + c,
            r, u;
        t.find(".t-af2-c1-body").length && (r = t.find(".js-a-sidebar-adjust-elm-ref").eq(0).outerHeight(), i = r + t.find(".t-af2-c1-top").eq(0).outerHeight() + t.find(".t-af2-c1-body").eq(0).outerHeight());
        u = function() {
            var n = jQuery(window).width();
            return n < 1024 ? 700 : 920
        };
        t.is('[data-truncated="true"]') ? (n.css("max-height", i), n.addClass("t-a-content-rm t-a-content-rm-ready js-a-content-rm-ready")) : e > u() + 100 && n.addClass("t-a-content-rm t-a-content-rm-ready js-a-content-rm-ready")
    })
}
...
function tabSys1() {
    jQuery("body").off("click", ".js-tabs-sys-1 .js-tabs-sys-1-index li").on("click", ".js-tabs-sys-1 .js-tabs-sys-1-index li", function() {
        var t = "current",
            n, i, r, u;
        jQuery(this).hasClass(t) || (n = jQuery(this).closest(".js-tabs-sys-1"), jQuery(this).siblings("li").removeClass(t), jQuery(this).addClass(t), n.find(".js-tabs-sys-1-content > div").hide(), i = n.children(".js-tabs-sys-1-index").find("li").index(n.children(".js-tabs-sys-1-index").find("." + t + ":eq(0)")), n.find(".js-tabs-sys-1-content > div").eq(i).fadeIn(), n.is(".js-tabs-sys-1-sync") && (r = n.closest(".js-tabs-sys-1-sync-wrap"), u = r.find(".js-tabs-sys-1-sync-list select"), u.val(i)))
    });
    jQuery("body").off("change", ".js-tabs-sys-1-sync-list select").on("change", ".js-tabs-sys-1-sync-list select", function() {
        var n = jQuery(this).closest(".js-tabs-sys-1-sync-wrap"),
            t = n.find(".js-tabs-sys-1-index li"),
            i = jQuery(this)[0].selectedIndex;
        t.eq(i).click()
    })
}
...
function appArticleLightbox1Init() {
    var t = jQuery(".js-lb-wrap-1"),
        n = jQuery('body.t-body-article main.t-main article[rel="detalhe-artigo"] figure[rel="img-artigo"]'),
    ...
    if (t.length) {
        n.each(function(r) {
            ...
            if (u.length) {
                ...
                t.find(".js-lb-content-items").append(s);
                r + 1 === n.length && (jQuery("body").addClass("interaction-article-lightbox-ready interaction-article-lightbox-closed"), appArticleLightbox1Slider(".js-lb-content-items"), jQuery(".js-lb-sb-pretitle em").text(n.length), jQuery(".js-lb-sb-title span").text(i));
                u.on("click", function() {
                    typeof lightbox_gallery_1 != "undefined" ? (lightbox_gallery_1.goToSlide(r + 1), appChangeWinURL1(r + 1)) : lightbox_gallery_1.goToSlide(1);
                    jQuery(".js-lb-sb-body").scrollTop(0);
        ...
        jQuery("body").off("click", ".js-lb-sb-share-comment").on("click", ".js-lb-sb-share-comment", function() {
            return jQuery(".js-lb-close, .js-a-content-rm-btn").click(), jQuery("html, body").stop().animate({
...
function appArticleChapterNavInit() {
    var n = jQuery(".js-chapter-nav-trigger-1"),
        t = n.closest(".js-a-content-rm");
    jQuery("body").off("click", ".js-chapter-nav-trigger-1 li a").on("click", ".js-chapter-nav-trigger-1 li a", function() {
        if (!t.hasClass("t-a-content-rm-ready")) {
            var i = jQuery(this).attr("href"),
                n = jQuery(this).closest(".js-chapter-scroll-1");
            n.length && n.hide().addClass("t-chapter-scrolling-wrap-hide");
            jQuery("html, body").stop().animate({
                scrollTop: jQuery(i).eq(0).offset().top - 130
            }, 400, function() {
                n.show().removeClass("t-chapter-scrolling-wrap-hide")
            });
            setTimeout(function() {
                n.length && n.hide().addClass("t-chapter-scrolling-wrap-hide");
                jQuery("html, body").stop().animate({
...
(function() {
    jQuery(function() {
        ...
        windowAdjustOnClick();
        windowAdjustOnKeyboard();
        appOverlayCloseActions();
        appOverlayMeteoActions();
        appOverlayNotificationsActions();
        ...
        slidersInit();
        articleAdjustLayout();
        jQuery(".js-a-sidebar-adjust-elm-ref").on("mresize", function() {
            articleAdjustLayout()
        });
        contentShowMore();
        contentCollapse();
        ...
        jQuery("body").off("click", ".js-a-content-rm-btn").on("click", ".js-a-content-rm-btn", function() {
            var u = jQuery(this).closest('[rel="detalhe-artigo"]'),
                ...
                t = n.find(".js-a-content-rm-full").eq(0),
                f = t.outerHeight(),
                i = t.find(".js-a-content-body-elm-targ").eq(0),
                e = i.attr("js-data-ref-height"),
                r = jQuery(".chapters-report").eq(0);
            n.is(".js-a-content-rm-ready") && (u.is('[data-truncated="true"]') || i.css({
                "min-height": e + "px"
            }), n.css({
                "max-height": f
            }), setTimeout(function() {
            ...
            }, 1e3), articleReplaceDetailHtml && articleReplaceDetailHtml(), r.length && r.show())
        });
        appDropDowns();
        tabSys1();
        appArticleLightbox1Init();
        appArticleChapterNavInit();
