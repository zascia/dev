        ...
        <div class="one-card">
            ...
            <div class="one-card-inline-block one-card-align-left one-card-staging-content">
                ...
                <div class="one-staging-actions card-3">
                    <h3 class="no-top-margin entry-name"><?php _e( 'Copy staging to your live site', OC_PLUGIN_DOMAIN ); ?></h3>
					<?php
					...
					if(!empty( $existing_live) && isset($existing_live->directoryName)){ ?>
                        ...
                        <br><br>
                        <button id="deploy_to_live" class="one-button btn button_1 one-button-copy-to-live" data-dialog-id="staging-copy-confirmation" data-title="<?php _e( 'Are you sure?', OC_PLUGIN_DOMAIN ); ?>" data-width="460" data-height="170" data-live-id="<?php echo $existing_live->directoryName; ?>"><?php _e( 'Copy staging to live', OC_PLUGIN_DOMAIN ); ?></button>
						<?php
