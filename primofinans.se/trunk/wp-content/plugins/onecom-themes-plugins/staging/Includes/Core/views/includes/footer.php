...
<div id="staging-update-confirmation" style="display:none">
    <div class="one-dialog-container">
        ...
        <div class="one-dialog-container-content">
            ...
            <p align="right">
                <button class="one-button btn button_1 one-button-update-staging-confirm"><?php _e( 'OK', OC_PLUGIN_DOMAIN ); ?></button>
                <button class="one-button btn button_3 one-button-update-staging-cancel"><?php _e( 'Cancel', OC_PLUGIN_DOMAIN ); ?></button>
            </p>
        </div>
    </div>
</div>
<div id="staging-deployment-confirmation" style="display:none">
    <div class="one-dialog-container">
        ...
        <div class="one-dialog-container-content">
            ...
            <p align="right">
                <button class="one-button btn button_1 one-button-copy-to-live-confirm"><?php _e( 'OK', OC_PLUGIN_DOMAIN ); ?></button>
                <button class="one-button btn button_3 one-button-copy-to-live-cancel"><?php _e( 'Cancel', OC_PLUGIN_DOMAIN ); ?></button>
            </p>
        </div>
    </div>
</div>
<div id="staging-delete" style="display:none">
    <div class="one-dialog-container">
        ...
        <div class="one-dialog-container-content">
            ...
            <p align="right">
                <button class="one-button btn button_1 one-button-delete-staging-confirm"><?php _e( 'OK', OC_PLUGIN_DOMAIN ); ?></button>
                <button class="one-button btn button_3 one-button-delete-staging-cancel"><?php _e( 'Cancel', OC_PLUGIN_DOMAIN ); ?></button>
            </p>
        </div>
    </div>
</div>
...
<div id="staging-copy-confirmation" style="display:none">
    <div class="one-dialog-container">
        ...
        <div class="one-dialog-container-content">
            ...
            <p align="right">
                <button id="one-button-copy-to-live-confirm" class="one-button btn button_1 one-button-copy-to-live-confirm"><?php _e( 'OK', OC_PLUGIN_DOMAIN ); ?></button>
                <button class="one-button btn button_3 one-button-copy-to-live-cancel"><?php _e( 'Cancel', OC_PLUGIN_DOMAIN ); ?></button>
            </p>
        </div>
    </div>
