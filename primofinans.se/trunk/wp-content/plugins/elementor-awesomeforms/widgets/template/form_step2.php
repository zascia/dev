...
<div class="second-step-form">
    <div class="swedish-version">
        ...
        <div class="response-text response-success">
            <h2>Tack för din låneansökan!</h2>
            <p><br>
                Din låneansökan behandlas nu personligen av vår klient för att hitta det bästa låneerbjudande baserat på dina behov. </p>
            <p>Så snart vi fått in ett eller flera låneerbjudanden kommer vi att kontakta dig.</p>
            <br />
            Observera att ansökningar som skickas utanför normal arbetstid kommer att behandlas senast följande arbetsdag. 
            <br><br>
        ...
        <div class="response-text response-reject">
            <br>
            <h2>Tack for din ansökan!</h2>
            Medan du väntar på att Axo Finans ska höra av sig till dig är du välkommen att ansökan hos några av våra andra samarbetspartners - de värderar din ansökan på samma sätt som Axo Finans
            <br><br>
            Med vänliga hälsningar
            <br>
            Smartlånet
            ...
            <div class="banner-custom-block">
                <div class="banner-custom-wrapper">
                    <div class="banner-custom-header">
                        <h2>Erbjudande nr.1</h2>
                    </div>
                    <div class="banner-custom-text">
                        <p>Löpetid i upp til 10 år. Du kan låna upp till 150.000 kr till en fast ränta. Du signerar säkert med Bank-ID och du får ett svar inom en timme under våra öppettider.</p>
                    </div>
                    <div class="banner-custom-bottom-content">
                        <div class="banner-custom-list">
                            <ul>
                                <li><span>&#x2714;</span> Belop 10.000 - 150.000 kr</li>
                                <li><span>&#x2714;</span> Fast ränta</li>
                            </ul>
                        </div>
                        <div class="banner-custom-button-container">
                            <a class="banner-custom-button" href="https://secure.smartresponse-media.com/?a=14611&c=232523&s1=smartlaanetSEtcejer" title="">Ansök nu <span class="next-arrow">⇨</span></a>
                        </div>
                    </div>
                </div>
                <div class="banner-custom-wrapper">
                    <div class="banner-custom-header">
                        <h2>Erbjudande nr. 2</h2>
                    </div>
                    <div class="banner-custom-text">
                        <p>Löpetid i upp til 20 år. Jämför lån kostnadsfritt hos över 30 banker och långivare.</p>
                    </div>
                    <div class="banner-custom-bottom-content">
                        <div class="banner-custom-list">
                            <ul>
                                <li><span>&#x2714;</span> Belop 5.000 - 600.000 kr</li>
                                <li><span>&#x2714;</span> 1 kreditupplysning</li>
                            </ul>
                        </div>
                        <div class="banner-custom-button-container">
                            <a class="banner-custom-button" href="https://secure.smartleadcampaign.com/?a=14611&c=230081&p=r&s1=smartlaanetSEtcejer" title="">Ansök nu <span class="next-arrow">⇨</span></a>
                        </div>
                    </div>
                </div>
                <div class="banner-custom-wrapper">
                    <div class="banner-custom-header">
                        <h2>Erbjudande nr. 3</h2>
                    </div>
                    <div class="banner-custom-text">
                        <p>Samla dina lån & krediter — sänk din månadskostnad</p>
                    </div>
                    <div class="banner-custom-bottom-content">
                        <div class="banner-custom-list">
                            <ul>
                                <li><span>&#x2714;</span> Belop 5.000 - 600.000 kr</li>
                                <li><span>&#x2714;</span> 39 långivare - 1 kreditupplysning</li>
                            </ul>
                        </div>
                        <div class="banner-custom-button-container">
                            <a class="banner-custom-button" href="https://secure.smartleadcampaign.com/?a=14611&c=230097&p=r&s1=smartlaanetSEtcejer" title="">Ansök nu <span class="next-arrow">⇨</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="response-text response-error">
            <h2>Vi upplever några tekniska problem med servern. Vänligen försök senare</h2>
        </div>
    </div>
</div>