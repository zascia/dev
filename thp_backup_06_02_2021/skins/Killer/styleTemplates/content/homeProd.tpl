...
<strong><center><H3 style="color:#0000A0">{HPP_HEAD} - 20. december</H3></center></strong><br />
	...
	<p>
		<h3><strong><img style="margin-left:20px;" src="http://www.nyah-beauty.com/images/ethnic_christmasGirl.jpg" alt="Glædelig Jul" border="0" />{LANG_PRICE}</strong> {TXT_PRICE} 
