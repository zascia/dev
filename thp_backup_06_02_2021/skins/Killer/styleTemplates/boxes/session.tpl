...
<!-- BEGIN: session_express -->
	<span class="txtSession">[{LANG_WELCOME_BACK} {TXT_USERNAME} | </span><a href="cart.php?act=upgradeReg&amp;redir={VAL_SELF}" class="txtSession">{LANG_REGISTER}</a> <span class="txtSession">]</span>
<!-- END: session_express -->
</div>
