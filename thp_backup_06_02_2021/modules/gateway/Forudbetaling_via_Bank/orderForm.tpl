...
{VAL_STORE_URL}</td>
  ...
  <tr>
    ...
    <td align="left" valign="top" class="copyText">
	<strong>{LANG_CART_ORDER_ID}</strong> {VAL_CART_ORDER_ID}
    <!-- BEGIN: faktura --><br /><strong>{TXT_FAKTURA}:</strong> {VAL_FAKTURA}<!-- END: faktura -->
    </td>
  </tr>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="7" cellspacing="0" style="padding: 7px;">
	  ...
	  <tr>
	    <td rowspan="5" align="left" valign="top" class="copyText">
	...
	<tr>
	    <td class="copyText">{LANG_COUPON}</td>
	    <td align="right" class="copyText">-{VAL_COUPON}</td>
	  </tr>
	  <tr>
