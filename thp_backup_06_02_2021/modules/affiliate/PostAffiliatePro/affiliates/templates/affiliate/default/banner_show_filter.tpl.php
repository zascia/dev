...
<tr class="listheader"><td>
  ...
  <table width="100%">
   ...
   <tr class="listheader">
      <td align=left>
        <table cellpadding="2" cellspacing="0" border="0">
        <tr><td valign=top width="150" align=left>&nbsp;<b><?php echo L_G_SHOWBANNERSTATS?></b>&nbsp;<?php showQuickHelp(L_G_HLP_SHOWBANNERSTATS); ?><br></td>
            <td align="left">
             <input type="checkbox" name="bs_show_stats" size="35" value="1" <?php echo  ($_REQUEST['bs_show_stats'] == '1') ? 'checked': ''?>></td></tr>
        </table>
      </td>
    </tr>
  ...
  <tr>
   ...
   <tr>
      <td align=left colspan=2>
        <?php
            $this->a_this->assign('a_timeselect_caption', '<b>'.L_G_BANNERSTATSPERIOD.'</b>');
            QUnit_Global::includeTemplate('filter_time.tpl.php'); ?>
      </td>
    </tr>
   <tr>
     <td colspan=2 align=left>
      ...
      <input type=hidden name=list_page id=list_page value="<?php echo $_REQUEST['list_page']?>">
