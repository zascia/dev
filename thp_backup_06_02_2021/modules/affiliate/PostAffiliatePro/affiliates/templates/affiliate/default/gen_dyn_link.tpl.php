    ...
    <?php QUnit_Templates::printFilter(2, L_G_DYNAMICLINK) ?>
      ...
      <tr>
        <td align=left colspan=2><?php echo L_G_CODETOINSERT?><br>
          <center>
          <textarea cols=90 rows=6><?php echo $this->a_bannerCode?></textarea>
          </center>
        </td>
      </tr>
    <tr>
      ...
      <input type=button class=formbutton value='<?php echo L_G_BACK?>'  onClick='javascript:document.location.href="index_popup.php?md=Affiliate_Affiliates_Views_AffBannerManager&action=dynamiclink&bid=<?php echo $_REQUEST['bid']?>&<?php echo SID?>";'>&nbsp;&nbsp;&nbsp;
