...
<tr><td align="center"><?php if ($this->a_line != -1) { ?><?php echo L_G_PLEASEWAIT." ".L_G_IMPORTINGPARENTRELATIONS?><?php } ?></td></tr>
<tr><td align="left">
<?php if ($this->a_line == -1) { ?>
    ...
    <?php } ?>
     <?php if ($_SESSION['ai_errorLines'] != '') { ?>
        <?php echo L_G_ERRORIMPORTINGPARENT_RELATIONSFOR?> <?php echo $_SESSION['ai_errorLines']?>
    <?php } ?>
<?php } else { ?>
