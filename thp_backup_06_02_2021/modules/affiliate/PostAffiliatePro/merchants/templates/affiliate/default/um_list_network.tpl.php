<?php
QUnit_Global::includeTemplate('um_filter_network.tpl.php');
?>
    ...
    <tr>
        <td class=actionheader align=left>
          <?php if($this->a_action_permission['view']) { ?>
            <b><a class=mainlink href="javascript:showTree();"><?php echo L_G_SHOWTREE?></a></b>
          <?php } ?>
        </td>
    </tr>    
    <tr>
        ...
        <tr>
            <td class=listViewLine>
                <?php $this->a_this->printAvailableViews('Affiliate_Merchants_Views_AffiliateManagerNetwork'); ?>
            </td>
        </tr>
        </table>
    ...
    <tr>
        ...
        <tr class=listheader>
            <?php $this->a_this->printListHeader(false); ?>
        </tr>
</form>
