...
<tr><td>
    ...
    <tr>
        <td width="25" align="left" style="padding-left:10px;">
            <input type="checkbox" name="showsection" <?php echo ($settings['Aff_menu_item_'.$this->a_menu_item.'_show'] == 'true')? 'checked' : ''?>>
    ...
    <tr>
        <td align="left" style="padding-left:10px;">
            <br><br>
            <input type="hidden" name="showcustomdescription" value="false">
            <b><?php echo L_G_FAQTEXT?><b><br><br>
            <textarea rows="30" cols="139" name="customdescription"><?php echo $settings['Aff_settings_'.$this->a_panel_type.'_customdescription']?></textarea><br>
        </td>
    </tr>    
    <tr>
        <td align="center">
