...
class Affiliate_Install_Bl_ScenarioUpgrade13x extends Affiliate_Install_Bl_Scenario 
{
    
    var $steps = array();
    
    function Affiliate_Install_Bl_ScenarioUpgrade13x() {
        $this->init(); 
    }    
    ...
    function init() {
        ...
        $this->addStep('DbConvert13x', L_G_DBCONVERT);
